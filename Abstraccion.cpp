...
//		return hr;
//
//	hr = MY_Device.GetDevice()->CreateRenderTargetView(pBackBuffer, NULL, &g_pRenderTargetView);
//	pBackBuffer->Release();
//	if (FAILED(hr))
//		return hr;
//
...
//
//	hr = MY_Device.GetDevice()->CreateTexture2D(&descDepth, NULL, &g_pDepthStencil);
//	if (FAILED(hr))
//		return hr;
//
...
//	hr = MY_Device.GetDevice()->CreateDepthStencilView(g_pDepthStencil, &descDSV, &g_pDepthStencilView);
//	if (FAILED(hr))
//		return hr;
//
...
//	hr = CompileShaderFromFile(L"Abstraccion.fx", "VS", "vs_4_0", &pVSBlob);
//	if (FAILED(hr))
//	{
//		MessageBox(NULL,
